...
In this hands-on exercise, you will learn how to create interactive data visualization by using functions provided by **ggiraph** and **plotlyr** packages.

## 3.2 package will be use in the exercise
...
## 3.3 Importing Data In this exercise we will still working on Exam_data.csv.The read_csv() will be applied to import the data. The code chunk below are the read_csv() used to import the data set into R environment
